...
public: // Methods
	...
	void GetXYExtents(OdGePoint3d, OdGePoint3d, OdGePoint3d*, OdGePoint3d*);
	...
	void SetMajorAxis(const OdGeVector3d& majorAxis);
	void SetMinorAxis(const OdGeVector3d& minorAxis);
