...
EoDbDimension* EoDbDimension::Create(OdDbAlignedDimensionPtr& alignedDimension) {
	...
	const auto FirstExtensionLineStartPoint {alignedDimension->xLine1Point()};
	const auto SecondExtensionLineStartPoint {alignedDimension->xLine2Point()};
	...
	Dimension->SetStartPoint(FirstExtensionLineStartPoint);
	Dimension->SetEndPoint(SecondExtensionLineStartPoint);
	...
	auto XDirection {SecondExtensionLineStartPoint - FirstExtensionLineStartPoint};
