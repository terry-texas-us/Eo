...
private:
	enum GripPoints { kFirstExtensionLineStartPoint, kFirstExtensionLineEndPoint, kSecondExtensionLineStartPoint, kSecondExtensionLineEndPoint, kArcPoint, kTextPosition };
};
